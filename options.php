...
function optionsframework_options() {
	...
	// Заголовок 1
	$options[] = array(
		'name' => __('Основные опции', 'options_check'),
		'type' => 'heading');

	$options['logo'] = array(
		'name' => __('Загрузка логотипа', 'options_check'),
		'desc' => __('Загрузите логотип.', 'options_check'),
		'id' => 'logo',
		'type' => 'upload');

	$options['phone_text'] = array(
		'name' => __('Номер телефона', 'options_check'),
		'desc' => __('Введите номер телефона.', 'options_check'),
		'id' => 'phone_text',
		'std' => '',
		'type' => 'text');

	$options['skype'] = array(
		'name' => __('Скайп логин', 'options_check'),
		'desc' => __('Введите логин скайпа.', 'options_check'),
		'id' => 'skype',
		'std' => '',
		'type' => 'text');

	$options['e-mail_text'] = array(
		'name' => __('Электронная почта', 'options_check'),
		'desc' => __('Введите адресс e-meil.', 'options_check'),
		'id' => 'e-mail_text',
		'std' => 'rud.petro@gmail.com',
		'type' => 'text');

	$options['adress'] = array(
		'name' => __('Адрес', 'options_check'),
		'desc' => __('Введите адрес.', 'options_check'),
		'id' => 'adress',
		'std' => '',
		'type' => 'textarea');

	$options['copyright'] = array(
		'name' => __('Копирайт внизу подвала', 'options_check'),
		'desc' => __('Введите данные.', 'options_check'),
		'id' => 'copyright',
		'std' => '',
		'type' => 'textarea');
	...
	// Заголовок 2
	$options[] = array(
		'name' => __('Слайдер', 'options_check'),
		'type' => 'heading');

	$options['image_banner'] = array(
		'name' => __('Загрузка баннера', 'options_check'),
		'desc' => __('Загрузите изображение для главной страницы.', 'options_check'),
		'id' => 'image_banner',
		'type' => 'background');

	$options['image_slide_1'] = array(
		'name' => __('Загрузка слайда 1', 'options_check'),
		'desc' => __('Загрузите изображение для слайдера.', 'options_check'),
		'id' => 'image_slide_1',
		'type' => 'upload');

	$options['image_slide_2'] = array(
		'name' => __('Загрузка слайда 2', 'options_check'),
		'desc' => __('Загрузите изображение для слайдера.', 'options_check'),
		'id' => 'image_slide_2',
		'type' => 'upload');

	$options['image_slide_3'] = array(
		'name' => __('Загрузка слайда 3', 'options_check'),
		'desc' => __('Загрузите изображение для слайдера.', 'options_check'),
		'id' => 'image_slide_3',
		'type' => 'upload');

	$options[] = array(
		'name' => __('Заголовок текста слайдера', 'options_check'),
		'desc' => __('Введите заголовок текста для слайдера.', 'options_check'),
		'id' => 'head_slider',
		'std' => 'Добро пожаловать!',
		'type' => 'text');

	$options[] = array(
		'name' => __('Сообщение-текст слайдера', 'options_check'),
		'desc' => __('Введите свой текст, который будет выводится на слайдере.', 'options_check'),
		'id' => 'text_slider',
		'std' => 'Ваше сообщение',
		'type' => 'textarea');
	...
	$options[] = array(
		'name' => __('Текстовый блок', 'options_framework_theme'),
		'type' => 'info');
	...
	$options[] = array(
		'name' => __('Левая колонка заголовок', 'options_framework_theme'),
		'desc' => __('Enter text to use for the column heading.', 'options_framework_theme'),
		'id' => 'text-left-heading',
		'type' => 'text');

	$options[] = array(
		'name' => __('Левая колонка текст', 'options_framework_theme'),
		'desc' => __('Enter text to use for the column heading.', 'options_framework_theme'),
	...
	// Заголовок 3
	$options[] = array(
		'name' => __('Опции фреймворка', 'options_check'),
		'type' => 'heading');
